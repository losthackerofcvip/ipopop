...
bot = telebot.TeleBot('7350883849:AAEHzmgpKQQWT8zfX53bgMnVcp0JpT3FfSA')
# Admin user IDs
admin_id = ["948895728","5834054446","1712525673","1175384555","1881941753","7224546032","1906267455","6515611578","1871909759","6060545769"]
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @CRACKWAR0_FREE_USER_bot ❄."
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: VIP- @CRACKWAR0_FREE_USER_bot KA KALA JADU"
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /FUCK command.                                                                          DM TO BUY ACCESS:- @CRACKWAR0_FREE_USER_bot")
...
💥 /FUCK : Method For CRACKWAR0 Servers. 
...
Buy From :- @CRACKWAR0_FREE_USER_bot
